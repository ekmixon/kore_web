...
class Git(VersionControl):
    ...
    def is_commit_id_equal(self, dest, name):
        ...
        Args:
          ...
          name: a string name.
        """
        return self.get_revision(dest) == name if name else False
    ...
    def get_src_requirement(self, dist, location):
        ...
        req = f'{repo}@{current_rev}#egg={egg_project_name}'
        if subdirectory := self._get_subdirectory(location):
            req += f'&subdirectory={subdirectory}'
        return req
